            ...
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div class="cursor-pointer flex items-center">
                        ...
                        <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">Laravel Login</div>
                    </div>
                </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        @csrf
                            <div>
                                ...
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="email" name="email" placeholder="mike@gmail.com">
                            ...
                            <div class="mt-8">
                                ...
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" name="password" placeholder="Enter your password">
