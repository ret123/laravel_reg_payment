<x-app-layout>
    ...
    <div class="py-12">
        ...
        <section class="mb-40">
           <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="absolute block w-full" style=" top:0;margin: auto; z-index: -10;" height="680" preserveAspectRatio="none" viewBox="0 0 1920 880">
            ...
            <div class="container mx-auto px-6 md:px-12 xl:px-32">
                <div class="text-center text-gray-800">
                    <div class="block rounded-lg shadow-lg px-6 py-12 md:py-16 md:px-12" style="margin-top:30px;background-color: hsla(0, 0%, 100%, 0.8);backdrop-filter: saturate(200%) blur(25px);">
                        <h1 class="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">Best place in the market <br /><span class="text-blue-600">for good content by top writers </span></h1>
                        @sub
                        <h3 class="text-green-500 mb-4">You are authorized to view the content</h3>
                        <a href="{{ route('content') }}" class="inline-block px-7 py-3 mb-2 md:mb-0 mr-0 md:mr-2 bg-blue-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" href="#!" role="button">Exclusive Content</a>

                    
                        @else


                        <h3 class="text-red-600 mb-4">You are not authorized to view the content. Kindly subscribe to view the content, Only for INR 10</h3>
                        
                        <a href="{{ route('pay') }}" class="inline-block px-7 py-3 mb-2 md:mb-0 mr-0 md:mr-2 bg-blue-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" href="#!" role="button">Subscribe</a>
                        @endsub
                    </div>
                </div>
            </div>
